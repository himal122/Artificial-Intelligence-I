    ...
    for feature1 in range(num_features):
        ...
        for feature2 in range(num_features):
            ...
            if feature1 != feature2:
                axs[feature1, feature2].scatter(x_data, y_data, c=cluster_ids)
            else:
                ...
                for i, split in enumerate(splits):
                    axs[feature1, feature2].hist(split, bins=20, color=hist_col[i], edgecolor='black', alpha=0.7)


    # title with my name
    fig.suptitle(f'Visualisation of {K} clusters by h2-acharya', fontsize=16, y=0.95)
